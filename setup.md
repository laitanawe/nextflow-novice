...
(To create your Desktop directory, you can use: `mkdir -pv ~/Desktop/`)
2. Download <a href="https://laitanawe.github.io/nextflow-novice/data/nextflow-nov-lesson.tar.gz">nextflow-nov-lesson.tar.gz</a>
